...
type EventOptions struct {
	...
	AdditionalPayloadFields map[string]string `protobuf:"bytes,11,rep,name=additional_payload_fields,json=additionalPayloadFields,proto3" json:"additional_payload_fields,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *EventOptions) GetAdditionalPayloadFields() map[string]string {
	if x != nil {
		return x.AdditionalPayloadFields
	}
	return nil
}
...
type Event struct {
	...
	AdditionalPayload map[string]string `protobuf:"bytes,21,rep,name=additional_payload,json=additionalPayload,proto3" json:"additional_payload,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *Event) GetAdditionalPayload() map[string]string {
	if x != nil {
...
const file_qdrant_cloud_event_v1_events_proto_rawDesc = "" +
	"\n" +
	"\"qdrant/cloud/event/v1/events.proto\x12\x15qdrant.cloud.event.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a#qdrant/cloud/common/v1/common.proto\"\xef\x05\n" +
	"\fEventOptions\x12K\n" +
	"\n" +
	...
	" \x03(\v2@.qdrant.cloud.event.v1.EventOptions.AdditionalContextFieldsEntryR\x17additionalContextFields\x12|\n" +
	"\x19additional_payload_fields\x18\v \x03(\v2@.qdrant.cloud.event.v1.EventOptions.AdditionalPayloadFieldsEntryR\x17additionalPayloadFields\x1aJ\n" +
	"\x1cAdditionalContextFieldsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1aJ\n" +
	"\x1cAdditionalPayloadFieldsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
