...
type ResourceConfiguration struct {
	...
	// This is an optional field, if it is not set no GPU is provided.
	GpuMemory     *string `protobuf:"bytes,5,opt,name=gpu_memory,json=gpuMemory,proto3,oneof" json:"gpu_memory,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ResourceConfiguration) GetGpuMemory() string {
...
const file_qdrant_cloud_booking_v1_booking_proto_rawDesc = "" +
	...
	"\x0eprice_per_hour\x18\x02 \x01(\rR\fpricePerHour\"\xce\x01\n" +
	...
	"\n" +
	"gpu_memory\x18\x05 \x01(\tB\a\xbaH\x04r\x02\x10\x01H\x01R\tgpuMemory\x88\x01\x01B\x06\n" +
	"\x04_gpuB\r\n" +
	"\v_gpu_memory\"\xc0\x01\n" +
