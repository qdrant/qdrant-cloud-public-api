...
type ResourceConfiguration struct {
	...
	// The amount of GPU VRAM (e.g., "1GiB")
	// This is an optional field, if it is not set no GPU is provided.
	Vram          *string `protobuf:"bytes,5,opt,name=vram,proto3,oneof" json:"vram,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ResourceConfiguration) GetVram() string {
	if x != nil && x.Vram != nil {
		return *x.Vram
	}
	return ""
...
const file_qdrant_cloud_booking_v1_booking_proto_rawDesc = "" +
	...
	"\x0eprice_per_hour\x18\x02 \x01(\rR\fpricePerHour\"\xbd\x01\n" +
	...
	"\x04vram\x18\x05 \x01(\tB\a\xbaH\x04r\x02\x10\x01H\x01R\x04vram\x88\x01\x01B\x06\n" +
	"\x04_gpuB\a\n" +
	"\x05_vram\"\xc0\x01\n" +
