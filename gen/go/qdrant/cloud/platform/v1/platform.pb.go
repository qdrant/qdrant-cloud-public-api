...
const file_qdrant_cloud_platform_v1_platform_proto_rawDesc = "" +
	...
	"\x05items\x18\x01 \x03(\v2-.qdrant.cloud.platform.v1.CloudProviderRegionR\x05items\"n\n" +
	"\rCloudProvider\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1b\n" +
	"\tfree_tier\x18\x03 \x01(\bR\bfreeTier\x12\x1c\n" +
	"\tavailable\x18\x04 \x01(\bR\tavailable\"\xad\x02\n" +
	"\x13CloudProviderRegion\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1b\n" +
	"\tfree_tier\x18\x03 \x01(\bR\bfreeTier\x12\x1c\n" +
	"\tavailable\x18\x04 \x01(\bR\tavailable\x12\x1a\n" +
	"\bprovider\x18\x05 \x01(\tR\bprovider\x12-\n" +
	"\x10country_iso_code\x18\x06 \x01(\tH\x00R\x0ecountryIsoCode\x88\x01\x01\x12;\n" +
	"\x17geographical_sub_region\x18\a \x01(\tH\x01R\x15geographicalSubRegion\x88\x01\x01B\x13\n" +
