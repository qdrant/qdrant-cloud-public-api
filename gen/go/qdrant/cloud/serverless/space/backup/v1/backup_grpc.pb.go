...
const (
	BackupService_ListBackups_FullMethodName          = "/qdrant.cloud.serverless.space.backup.v1.BackupService/ListBackups"
	BackupService_GetBackup_FullMethodName            = "/qdrant.cloud.serverless.space.backup.v1.BackupService/GetBackup"
	BackupService_CreateBackup_FullMethodName         = "/qdrant.cloud.serverless.space.backup.v1.BackupService/CreateBackup"
	BackupService_DeleteBackup_FullMethodName         = "/qdrant.cloud.serverless.space.backup.v1.BackupService/DeleteBackup"
	BackupService_ListBackupRestores_FullMethodName   = "/qdrant.cloud.serverless.space.backup.v1.BackupService/ListBackupRestores"
	BackupService_RestoreBackup_FullMethodName        = "/qdrant.cloud.serverless.space.backup.v1.BackupService/RestoreBackup"
	BackupService_ListBackupSchedules_FullMethodName  = "/qdrant.cloud.serverless.space.backup.v1.BackupService/ListBackupSchedules"
	BackupService_GetBackupSchedule_FullMethodName    = "/qdrant.cloud.serverless.space.backup.v1.BackupService/GetBackupSchedule"
	BackupService_CreateBackupSchedule_FullMethodName = "/qdrant.cloud.serverless.space.backup.v1.BackupService/CreateBackupSchedule"
	BackupService_UpdateBackupSchedule_FullMethodName = "/qdrant.cloud.serverless.space.backup.v1.BackupService/UpdateBackupSchedule"
	BackupService_DeleteBackupSchedule_FullMethodName = "/qdrant.cloud.serverless.space.backup.v1.BackupService/DeleteBackupSchedule"
)
...
func (UnimplementedBackupServiceServer) ListBackupRestores(context.Context, *ListBackupRestoresRequest) (*ListBackupRestoresResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListBackupRestores not implemented")
}
...
func (UnimplementedBackupServiceServer) GetBackupSchedule(context.Context, *GetBackupScheduleRequest) (*GetBackupScheduleResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetBackupSchedule not implemented")
}
...
func (UnimplementedBackupServiceServer) UpdateBackupSchedule(context.Context, *UpdateBackupScheduleRequest) (*UpdateBackupScheduleResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateBackupSchedule not implemented")
}
...
var BackupService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "qdrant.cloud.serverless.space.backup.v1.BackupService",
	...
	Metadata: "qdrant/cloud/serverless/space/backup/v1/backup.proto",
}
