...
const (
	CollectionService_ListCollections_FullMethodName   = "/qdrant.cloud.serverless.collections.v1.CollectionService/ListCollections"
	CollectionService_CreateCollection_FullMethodName  = "/qdrant.cloud.serverless.collections.v1.CollectionService/CreateCollection"
	CollectionService_UpgradeCollection_FullMethodName = "/qdrant.cloud.serverless.collections.v1.CollectionService/UpgradeCollection"
	CollectionService_DeleteCollection_FullMethodName  = "/qdrant.cloud.serverless.collections.v1.CollectionService/DeleteCollection"
)
...
func (c *collectionServiceClient) UpgradeCollection(ctx context.Context, in *UpgradeCollectionRequest, opts ...grpc.CallOption) (*UpgradeCollectionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpgradeCollectionResponse)
	err := c.cc.Invoke(ctx, CollectionService_UpgradeCollection_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCollectionServiceServer) UpgradeCollection(context.Context, *UpgradeCollectionRequest) (*UpgradeCollectionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpgradeCollection not implemented")
}
...
func _CollectionService_UpgradeCollection_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpgradeCollectionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CollectionServiceServer).UpgradeCollection(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CollectionService_UpgradeCollection_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CollectionServiceServer).UpgradeCollection(ctx, req.(*UpgradeCollectionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CollectionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "qdrant.cloud.serverless.collections.v1.CollectionService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpgradeCollection",
			Handler:    _CollectionService_UpgradeCollection_Handler,
		},
		{
	...
	Metadata: "qdrant/cloud/serverless/collections/v1/collections.proto",
}
