...
const (
	QuotaService_GetQuotas_FullMethodName = "/qdrant.cloud.serverless.quota.v1.QuotaService/GetQuotas"
)
...
var QuotaService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "qdrant.cloud.serverless.quota.v1.QuotaService",
	...
	Metadata: "qdrant/cloud/serverless/quota/v1/quota.proto",
}
