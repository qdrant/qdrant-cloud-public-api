...
const file_qdrant_cloud_ui_v1_featureflags_proto_rawDesc = "" +
	...
	"*cluster_storage_tier_configuration_enabled\x18\x06 \x01(\bR&clusterStorageTierConfigurationEnabled2\xb4\x01\n" +
	"\x13FeatureFlagsService\x12\x94\x01\n" +
	"\x0fGetFeatureFlags\x12*.qdrant.cloud.ui.v1.GetFeatureFlagsRequest\x1a+.qdrant.cloud.ui.v1.GetFeatureFlagsResponse\"(\x8a\xb5\x18\x00\x92\xb5\x18\x00\x82\xd3\xe4\x93\x02\x1a\x12\x18/api/ui/v1/feature-flags\x1a\x06µ\x18\x02\b\x01B\xe0\x01\n" +
