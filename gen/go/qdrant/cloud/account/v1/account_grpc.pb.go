...
func (c *accountServiceClient) SuggestCompanies(ctx context.Context, in *SuggestCompaniesRequest, opts ...grpc.CallOption) (*SuggestCompaniesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SuggestCompaniesResponse)
	err := c.cc.Invoke(ctx, AccountService_SuggestCompanies_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAccountServiceServer) LeaveAccount(context.Context, *LeaveAccountRequest) (*LeaveAccountResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method LeaveAccount not implemented")
}
func (UnimplementedAccountServiceServer) ListAccountInvites(context.Context, *ListAccountInvitesRequest) (*ListAccountInvitesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListAccountInvites not implemented")
}
func (UnimplementedAccountServiceServer) ListReceivedAccountInvites(context.Context, *ListReceivedAccountInvitesRequest) (*ListReceivedAccountInvitesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListReceivedAccountInvites not implemented")
}
func (UnimplementedAccountServiceServer) GetAccountInvite(context.Context, *GetAccountInviteRequest) (*GetAccountInviteResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAccountInvite not implemented")
}
func (UnimplementedAccountServiceServer) CreateAccountInvite(context.Context, *CreateAccountInviteRequest) (*CreateAccountInviteResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateAccountInvite not implemented")
}
func (UnimplementedAccountServiceServer) DeleteAccountInvite(context.Context, *DeleteAccountInviteRequest) (*DeleteAccountInviteResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteAccountInvite not implemented")
}
func (UnimplementedAccountServiceServer) AcceptAccountInvite(context.Context, *AcceptAccountInviteRequest) (*AcceptAccountInviteResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AcceptAccountInvite not implemented")
}
func (UnimplementedAccountServiceServer) RejectAccountInvite(context.Context, *RejectAccountInviteRequest) (*RejectAccountInviteResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RejectAccountInvite not implemented")
}
...
func (UnimplementedAccountServiceServer) GetAccountMember(context.Context, *GetAccountMemberRequest) (*GetAccountMemberResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAccountMember not implemented")
}
...
func _AccountService_SuggestCompanies_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SuggestCompaniesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccountServiceServer).SuggestCompanies(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AccountService_SuggestCompanies_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).SuggestCompanies(ctx, req.(*SuggestCompaniesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
