...
func (UnimplementedPaymentServiceServer) GetPaymentMethodAvailability(context.Context, *GetPaymentMethodAvailabilityRequest) (*GetPaymentMethodAvailabilityResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPaymentMethodAvailability not implemented")
}
...
func (UnimplementedPaymentServiceServer) GetStripeCheckoutSession(context.Context, *GetStripeCheckoutSessionRequest) (*GetStripeCheckoutSessionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetStripeCheckoutSession not implemented")
}
func (UnimplementedPaymentServiceServer) CreateStripeCheckoutSession(context.Context, *CreateStripeCheckoutSessionRequest) (*CreateStripeCheckoutSessionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateStripeCheckoutSession not implemented")
}
func (UnimplementedPaymentServiceServer) RecordCloudMarketplaceEntitlement(context.Context, *RecordCloudMarketplaceEntitlementRequest) (*RecordCloudMarketplaceEntitlementResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RecordCloudMarketplaceEntitlement not implemented")
}
