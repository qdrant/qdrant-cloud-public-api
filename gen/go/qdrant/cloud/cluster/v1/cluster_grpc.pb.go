...
func (UnimplementedClusterServiceServer) CreateClusterFromBackup(context.Context, *CreateClusterFromBackupRequest) (*CreateClusterFromBackupResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateClusterFromBackup not implemented")
}
...
func (UnimplementedClusterServiceServer) SuspendCluster(context.Context, *SuspendClusterRequest) (*SuspendClusterResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SuspendCluster not implemented")
}
...
func (UnimplementedClusterServiceServer) ListQdrantReleases(context.Context, *ListQdrantReleasesRequest) (*ListQdrantReleasesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListQdrantReleases not implemented")
}
func (UnimplementedClusterServiceServer) GetQdrantRelease(context.Context, *GetQdrantReleaseRequest) (*GetQdrantReleaseResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetQdrantRelease not implemented")
}
