...
const (
	DatabaseApiKeyService_ListDatabaseApiKeys_FullMethodName  = "/qdrant.cloud.cluster.auth.v3.DatabaseApiKeyService/ListDatabaseApiKeys"
	DatabaseApiKeyService_CreateDatabaseApiKey_FullMethodName = "/qdrant.cloud.cluster.auth.v3.DatabaseApiKeyService/CreateDatabaseApiKey"
	DatabaseApiKeyService_DeleteDatabaseApiKey_FullMethodName = "/qdrant.cloud.cluster.auth.v3.DatabaseApiKeyService/DeleteDatabaseApiKey"
)
...
var DatabaseApiKeyService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "qdrant.cloud.cluster.auth.v3.DatabaseApiKeyService",
	...
	Metadata: "qdrant/cloud/cluster/auth/v3/database_api_key.proto",
}
