...
const (
	DatabaseApiKeyService_ListDatabaseApiKeys_FullMethodName  = "/qdrant.cloud.cluster.auth.v1.DatabaseApiKeyService/ListDatabaseApiKeys"
	DatabaseApiKeyService_CreateDatabaseApiKey_FullMethodName = "/qdrant.cloud.cluster.auth.v1.DatabaseApiKeyService/CreateDatabaseApiKey"
	DatabaseApiKeyService_DeleteDatabaseApiKey_FullMethodName = "/qdrant.cloud.cluster.auth.v1.DatabaseApiKeyService/DeleteDatabaseApiKey"
)
...
func (UnimplementedDatabaseApiKeyServiceServer) ListDatabaseApiKeys(context.Context, *ListDatabaseApiKeysRequest) (*ListDatabaseApiKeysResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListDatabaseApiKeys not implemented")
}
func (UnimplementedDatabaseApiKeyServiceServer) CreateDatabaseApiKey(context.Context, *CreateDatabaseApiKeyRequest) (*CreateDatabaseApiKeyResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateDatabaseApiKey not implemented")
}
func (UnimplementedDatabaseApiKeyServiceServer) DeleteDatabaseApiKey(context.Context, *DeleteDatabaseApiKeyRequest) (*DeleteDatabaseApiKeyResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteDatabaseApiKey not implemented")
}
...
func RegisterDatabaseApiKeyServiceServer(s grpc.ServiceRegistrar, srv DatabaseApiKeyServiceServer) {
	// If the following call panics, it indicates UnimplementedDatabaseApiKeyServiceServer was
...
var DatabaseApiKeyService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "qdrant.cloud.cluster.auth.v1.DatabaseApiKeyService",
	...
	Metadata: "qdrant/cloud/cluster/auth/v1/database_api_key.proto",
}
