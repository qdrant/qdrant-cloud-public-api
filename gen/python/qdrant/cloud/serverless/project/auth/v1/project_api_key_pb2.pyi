...
class ListProjectApiKeysRequest(_message.Message):
...
class ListProjectApiKeysResponse(_message.Message):
    __slots__ = ("items",)
    ITEMS_FIELD_NUMBER: _ClassVar[int]
    items: _containers.RepeatedCompositeFieldContainer[ProjectApiKey]
    def __init__(self, items: _Optional[_Iterable[_Union[ProjectApiKey, _Mapping]]] = ...) -> None: ...

class CreateProjectApiKeyRequest(_message.Message):
    __slots__ = ("project_api_key",)
    PROJECT_API_KEY_FIELD_NUMBER: _ClassVar[int]
    project_api_key: ProjectApiKey
    def __init__(self, project_api_key: _Optional[_Union[ProjectApiKey, _Mapping]] = ...) -> None: ...

class CreateProjectApiKeyResponse(_message.Message):
    __slots__ = ("project_api_key",)
    PROJECT_API_KEY_FIELD_NUMBER: _ClassVar[int]
    project_api_key: ProjectApiKey
    def __init__(self, project_api_key: _Optional[_Union[ProjectApiKey, _Mapping]] = ...) -> None: ...

class DeleteProjectApiKeyRequest(_message.Message):
    __slots__ = ("account_id", "project_id", "project_api_key_id")
    ACCOUNT_ID_FIELD_NUMBER: _ClassVar[int]
    PROJECT_ID_FIELD_NUMBER: _ClassVar[int]
    PROJECT_API_KEY_ID_FIELD_NUMBER: _ClassVar[int]
    account_id: str
    project_id: str
    project_api_key_id: str
    def __init__(self, account_id: _Optional[str] = ..., project_id: _Optional[str] = ..., project_api_key_id: _Optional[str] = ...) -> None: ...

class DeleteProjectApiKeyResponse(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ProjectApiKey(_message.Message):
    __slots__ = ("id", "account_id", "created_at", "project_id", "name", "expires_at", "access_rules", "created_by_email", "postfix", "key")
