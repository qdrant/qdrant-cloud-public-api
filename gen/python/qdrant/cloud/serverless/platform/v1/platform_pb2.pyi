...
class CloudProvider(_message.Message):
    ...
    name: str
    available: bool
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., available: _Optional[bool] = ...) -> None: ...

class CloudProviderRegion(_message.Message):
    __slots__ = ("id", "name", "available", "provider", "country_iso_code", "geographical_sub_region")
    ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    AVAILABLE_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., available: _Optional[bool] = ..., provider: _Optional[str] = ..., country_iso_code: _Optional[str] = ..., geographical_sub_region: _Optional[str] = ...) -> None: ...
