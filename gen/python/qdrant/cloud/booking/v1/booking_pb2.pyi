...
class ResourceConfiguration(_message.Message):
    __slots__ = ("ram", "cpu", "disk", "gpu", "gpu_memory")
    ...
    gpu: str
    gpu_memory: str
    def __init__(self, ram: _Optional[str] = ..., cpu: _Optional[str] = ..., disk: _Optional[str] = ..., gpu: _Optional[str] = ..., gpu_memory: _Optional[str] = ...) -> None: ...
