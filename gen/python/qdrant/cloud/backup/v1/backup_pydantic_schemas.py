...
# whether it succeeded or failed.
    backup_duration: Annotated[timedelta, BeforeValidator(Timedelta.validate)] = Field(default_factory=timedelta)
...
# If the value is unset, backups will be retained indefinitely.
    retention_period: typing.Optional[Annotated[timedelta, BeforeValidator(Timedelta.validate)]] = Field(default_factory=timedelta)
