...
class AccountInviteStatus(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    ACCOUNT_INVITE_STATUS_EXPIRED: _ClassVar[AccountInviteStatus]
...
ACCOUNT_INVITE_STATUS_EXPIRED: AccountInviteStatus
...
class GetAccountMemberResponse(_message.Message):
    ...
    def __init__(self, member: _Optional[_Union[AccountMember, _Mapping]] = ...) -> None: ...
...
class AccountInvite(_message.Message):
    __slots__ = ("id", "account_id", "account_name", "email", "role_ids", "created_at", "created_by_user_id", "created_by_name", "expires_at", "last_modified_at", "user_id", "status")
    ID_FIELD_NUMBER: _ClassVar[int]
    ACCOUNT_ID_FIELD_NUMBER: _ClassVar[int]
