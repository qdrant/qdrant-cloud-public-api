...
class ClusterNodeResourcesSummary(_message.Message):
    __slots__ = ("disk", "ram", "cpu", "gpu", "vram")
    DISK_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, disk: _Optional[_Union[ClusterNodeResources, _Mapping]] = ..., ram: _Optional[_Union[ClusterNodeResources, _Mapping]] = ..., cpu: _Optional[_Union[ClusterNodeResources, _Mapping]] = ..., gpu: _Optional[_Union[ClusterNodeResources, _Mapping]] = ..., vram: _Optional[_Union[ClusterNodeResources, _Mapping]] = ...) -> None: ...
