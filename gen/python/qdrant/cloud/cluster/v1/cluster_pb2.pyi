...
class ClusterConfigurationRebalanceStrategy(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    CLUSTER_CONFIGURATION_REBALANCE_STRATEGY_DISABLED: _ClassVar[ClusterConfigurationRebalanceStrategy]
...
class ClusterPhase(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    CLUSTER_PHASE_UNKNOWN: _ClassVar[ClusterPhase]
...
class ClusterNodeNotReadyCondition(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    CLUSTER_NODE_NOT_READY_CONDITION_UNSPECIFIED: _ClassVar[ClusterNodeNotReadyCondition]
    CLUSTER_NODE_NOT_READY_CONDITION_POD_SCHEDULING_ERROR: _ClassVar[ClusterNodeNotReadyCondition]
    CLUSTER_NODE_NOT_READY_CONDITION_CONTAINER_START_BLOCKED: _ClassVar[ClusterNodeNotReadyCondition]
    CLUSTER_NODE_NOT_READY_CONDITION_CONTAINER_RESTARTING: _ClassVar[ClusterNodeNotReadyCondition]
    CLUSTER_NODE_NOT_READY_CONDITION_READINESS_FAILING: _ClassVar[ClusterNodeNotReadyCondition]
    CLUSTER_NODE_NOT_READY_CONDITION_UNKNOWN: _ClassVar[ClusterNodeNotReadyCondition]

class ClusterNodeNotReadyReason(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    CLUSTER_NODE_NOT_READY_REASON_UNSPECIFIED: _ClassVar[ClusterNodeNotReadyReason]
    CLUSTER_NODE_NOT_READY_REASON_INSUFFICIENT_RESOURCES: _ClassVar[ClusterNodeNotReadyReason]
    CLUSTER_NODE_NOT_READY_REASON_NODE_CONSTRAINTS_UNSATISFIED: _ClassVar[ClusterNodeNotReadyReason]
    CLUSTER_NODE_NOT_READY_REASON_VOLUME_UNAVAILABLE: _ClassVar[ClusterNodeNotReadyReason]
    CLUSTER_NODE_NOT_READY_REASON_IMAGE_UNAVAILABLE: _ClassVar[ClusterNodeNotReadyReason]
    CLUSTER_NODE_NOT_READY_REASON_CONFIGURATION_MISSING: _ClassVar[ClusterNodeNotReadyReason]
    CLUSTER_NODE_NOT_READY_REASON_OUT_OF_MEMORY: _ClassVar[ClusterNodeNotReadyReason]
    CLUSTER_NODE_NOT_READY_REASON_PROCESS_EXITED: _ClassVar[ClusterNodeNotReadyReason]

class ClusterNodeTerminationEvent(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    CLUSTER_NODE_TERMINATION_EVENT_UNSPECIFIED: _ClassVar[ClusterNodeTerminationEvent]
...
class ClusterNodeActionKind(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    CLUSTER_NODE_ACTION_KIND_VIEW_LOGS: _ClassVar[ClusterNodeActionKind]
...
class ClusterDownscaleRiskResource(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    CLUSTER_DOWNSCALE_RISK_RESOURCE_UNSPECIFIED: _ClassVar[ClusterDownscaleRiskResource]
    CLUSTER_DOWNSCALE_RISK_RESOURCE_MEMORY: _ClassVar[ClusterDownscaleRiskResource]

class ClusterDownscaleRiskStatus(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    CLUSTER_DOWNSCALE_RISK_STATUS_UNSPECIFIED: _ClassVar[ClusterDownscaleRiskStatus]
    CLUSTER_DOWNSCALE_RISK_STATUS_NO_RISK: _ClassVar[ClusterDownscaleRiskStatus]
    CLUSTER_DOWNSCALE_RISK_STATUS_USAGE_EXCEEDS_TARGET: _ClassVar[ClusterDownscaleRiskStatus]
    CLUSTER_DOWNSCALE_RISK_STATUS_USAGE_UNKNOWN: _ClassVar[ClusterDownscaleRiskStatus]
...
CLUSTER_CONFIGURATION_REBALANCE_STRATEGY_DISABLED: ClusterConfigurationRebalanceStrategy
...
CLUSTER_PHASE_UNKNOWN: ClusterPhase
...
CLUSTER_NODE_NOT_READY_CONDITION_UNSPECIFIED: ClusterNodeNotReadyCondition
CLUSTER_NODE_NOT_READY_CONDITION_POD_SCHEDULING_ERROR: ClusterNodeNotReadyCondition
CLUSTER_NODE_NOT_READY_CONDITION_CONTAINER_START_BLOCKED: ClusterNodeNotReadyCondition
CLUSTER_NODE_NOT_READY_CONDITION_CONTAINER_RESTARTING: ClusterNodeNotReadyCondition
CLUSTER_NODE_NOT_READY_CONDITION_READINESS_FAILING: ClusterNodeNotReadyCondition
CLUSTER_NODE_NOT_READY_CONDITION_UNKNOWN: ClusterNodeNotReadyCondition
CLUSTER_NODE_NOT_READY_REASON_UNSPECIFIED: ClusterNodeNotReadyReason
CLUSTER_NODE_NOT_READY_REASON_INSUFFICIENT_RESOURCES: ClusterNodeNotReadyReason
CLUSTER_NODE_NOT_READY_REASON_NODE_CONSTRAINTS_UNSATISFIED: ClusterNodeNotReadyReason
CLUSTER_NODE_NOT_READY_REASON_VOLUME_UNAVAILABLE: ClusterNodeNotReadyReason
CLUSTER_NODE_NOT_READY_REASON_IMAGE_UNAVAILABLE: ClusterNodeNotReadyReason
CLUSTER_NODE_NOT_READY_REASON_CONFIGURATION_MISSING: ClusterNodeNotReadyReason
CLUSTER_NODE_NOT_READY_REASON_OUT_OF_MEMORY: ClusterNodeNotReadyReason
CLUSTER_NODE_NOT_READY_REASON_PROCESS_EXITED: ClusterNodeNotReadyReason
...
CLUSTER_NODE_ACTION_KIND_VIEW_LOGS: ClusterNodeActionKind
...
CLUSTER_DOWNSCALE_RISK_RESOURCE_UNSPECIFIED: ClusterDownscaleRiskResource
CLUSTER_DOWNSCALE_RISK_RESOURCE_MEMORY: ClusterDownscaleRiskResource
CLUSTER_DOWNSCALE_RISK_STATUS_UNSPECIFIED: ClusterDownscaleRiskStatus
CLUSTER_DOWNSCALE_RISK_STATUS_NO_RISK: ClusterDownscaleRiskStatus
CLUSTER_DOWNSCALE_RISK_STATUS_USAGE_EXCEEDS_TARGET: ClusterDownscaleRiskStatus
CLUSTER_DOWNSCALE_RISK_STATUS_USAGE_UNKNOWN: ClusterDownscaleRiskStatus
...
class GetClusterDownscaleRiskRequest(_message.Message):
...
class GetClusterDownscaleRiskResponse(_message.Message):
    __slots__ = ("downscale_risks",)
    DOWNSCALE_RISKS_FIELD_NUMBER: _ClassVar[int]
    downscale_risks: _containers.RepeatedCompositeFieldContainer[ClusterDownscaleRiskInfo]
    def __init__(self, downscale_risks: _Optional[_Iterable[_Union[ClusterDownscaleRiskInfo, _Mapping]]] = ...) -> None: ...
...
class DatabaseConfigurationService(_message.Message):
    __slots__ = ("api_key", "read_only_api_key", "enable_tls")
...
class DatabaseConfigurationAuditLogging(_message.Message):
    __slots__ = ("enabled", "rotation", "max_log_files", "trust_forwarded_headers")
    ENABLED_FIELD_NUMBER: _ClassVar[int]
...
class ClusterStorageConfiguration(_message.Message):
    __slots__ = ("storage_tier_type", "database_storage_class", "snapshot_storage_class", "volume_snapshot_class", "volume_attributes_class")
...
class ClusterNodeInfo(_message.Message):
    __slots__ = ("name", "started_at", "version", "endpoint", "state", "availability_zone", "not_ready_info")
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    NOT_READY_INFO_FIELD_NUMBER: _ClassVar[int]
    name: str
...
class ClusterNodeNotReadyInfo(_message.Message):
    __slots__ = ("condition", "condition_message", "reason", "reason_message", "event", "event_message", "actions")
    CONDITION_FIELD_NUMBER: _ClassVar[int]
    CONDITION_MESSAGE_FIELD_NUMBER: _ClassVar[int]
    REASON_FIELD_NUMBER: _ClassVar[int]
    REASON_MESSAGE_FIELD_NUMBER: _ClassVar[int]
    EVENT_FIELD_NUMBER: _ClassVar[int]
    EVENT_MESSAGE_FIELD_NUMBER: _ClassVar[int]
    ACTIONS_FIELD_NUMBER: _ClassVar[int]
    condition: ClusterNodeNotReadyCondition
    condition_message: str
    reason: ClusterNodeNotReadyReason
    reason_message: str
    event: ClusterNodeTerminationEvent
    event_message: str
    actions: _containers.RepeatedCompositeFieldContainer[ClusterNodeAction]
    def __init__(self, condition: _Optional[_Union[ClusterNodeNotReadyCondition, str]] = ..., condition_message: _Optional[str] = ..., reason: _Optional[_Union[ClusterNodeNotReadyReason, str]] = ..., reason_message: _Optional[str] = ..., event: _Optional[_Union[ClusterNodeTerminationEvent, str]] = ..., event_message: _Optional[str] = ..., actions: _Optional[_Iterable[_Union[ClusterNodeAction, _Mapping]]] = ...) -> None: ...
...
class ClusterDownscaleRiskInfo(_message.Message):
    __slots__ = ("resource", "status", "reason")
    RESOURCE_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
    REASON_FIELD_NUMBER: _ClassVar[int]
    resource: ClusterDownscaleRiskResource
    status: ClusterDownscaleRiskStatus
    reason: str
    def __init__(self, resource: _Optional[_Union[ClusterDownscaleRiskResource, str]] = ..., status: _Optional[_Union[ClusterDownscaleRiskStatus, str]] = ..., reason: _Optional[str] = ...) -> None: ...
