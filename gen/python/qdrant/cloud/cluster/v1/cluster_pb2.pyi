...
class ClusterNodeResourcesSummary(_message.Message):
    __slots__ = ("disk", "ram", "cpu", "gpu", "gpu_memory")
    DISK_FIELD_NUMBER: _ClassVar[int]
    ...
    gpu_memory: ClusterNodeResources
    def __init__(self, disk: _Optional[_Union[ClusterNodeResources, _Mapping]] = ..., ram: _Optional[_Union[ClusterNodeResources, _Mapping]] = ..., cpu: _Optional[_Union[ClusterNodeResources, _Mapping]] = ..., gpu: _Optional[_Union[ClusterNodeResources, _Mapping]] = ..., gpu_memory: _Optional[_Union[ClusterNodeResources, _Mapping]] = ...) -> None: ...
