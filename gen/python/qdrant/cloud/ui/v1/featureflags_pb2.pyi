...
class GetFeatureFlagsResponse(_message.Message):
    __slots__ = ("cluster_creation_enabled", "billing_cycles_enabled", "entitlement_cancel_flow_enabled", "qdrant_clusters_querying_enabled")
    ...
    def __init__(self, cluster_creation_enabled: _Optional[bool] = ..., billing_cycles_enabled: _Optional[bool] = ..., entitlement_cancel_flow_enabled: _Optional[bool] = ..., qdrant_clusters_querying_enabled: _Optional[bool] = ...) -> None: ...
