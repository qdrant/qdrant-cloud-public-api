 ...
 * @generated from message google.api.Http
 */
export declare type HttpValid = Message<"google.api.Http"> & {
  /**
   * A list of HTTP configuration rules that apply to individual API methods.
   *
   * **NOTE:** All service configuration rules follow "last one wins" order.
 ...
 */
export declare const HttpSchema: GenMessage<Http, {validType: HttpValid}>;
 ...
 * @generated from message google.api.HttpRule
 */
export declare type HttpRuleValid = Message<"google.api.HttpRule"> & {
  /**
   * Selects a method to which this rule applies.
   *
   * Refer to [selector][google.api.DocumentationRule.selector] for syntax
   ...
   * @generated from field: repeated google.api.HttpRule additional_bindings = 11;
   */
  additionalBindings: HttpRuleValid[];
};
 ...
 */
export declare const HttpRuleSchema: GenMessage<HttpRule, {validType: HttpRuleValid}>;
 ...
 * @generated from message google.api.CustomHttpPattern
 */
export declare type CustomHttpPatternValid = Message<"google.api.CustomHttpPattern"> & {
  /**
   * The name of this custom HTTP verb.
   *
   * @generated from field: string kind = 1;
 ...
 */
export declare const CustomHttpPatternSchema: GenMessage<CustomHttpPattern, {validType: CustomHttpPatternValid}>;
