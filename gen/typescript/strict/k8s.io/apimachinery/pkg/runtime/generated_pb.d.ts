 ...
 * @generated from message k8s.io.apimachinery.pkg.runtime.RawExtension
 */
export declare type RawExtensionValid = Message<"k8s.io.apimachinery.pkg.runtime.RawExtension"> & {
  /**
   * Raw is the underlying serialization of this object.
   *
   * TODO: Determine how to detect ContentType and ContentEncoding of 'Raw' data.
 ...
 */
export declare const RawExtensionSchema: GenMessage<RawExtension, {validType: RawExtensionValid}>;
 ...
 * @generated from message k8s.io.apimachinery.pkg.runtime.TypeMeta
 */
export declare type TypeMetaValid = Message<"k8s.io.apimachinery.pkg.runtime.TypeMeta"> & {
  /**
   * +optional
   *
   * @generated from field: optional string apiVersion = 1;
 ...
 * @generated from message k8s.io.apimachinery.pkg.runtime.Unknown
 */
export declare type UnknownValid = Message<"k8s.io.apimachinery.pkg.runtime.Unknown"> & {
  /**
   * @generated from field: optional k8s.io.apimachinery.pkg.runtime.TypeMeta typeMeta = 1;
   */
  typeMeta?: TypeMetaValid;
 ...
 */
export declare const UnknownSchema: GenMessage<Unknown, {validType: UnknownValid}>;
