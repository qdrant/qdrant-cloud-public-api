...
import type { LabelSelector, LabelSelectorValid, ListMeta, ListMetaValid, ObjectMeta, ObjectMetaValid } from "../../../apimachinery/pkg/apis/meta/v1/generated_pb.js";
import type { LoadBalancerStatus, LoadBalancerStatusValid, TypedLocalObjectReference, TypedLocalObjectReferenceValid } from "../../core/v1/generated_pb.js";
 ...
 * @generated from message k8s.io.api.networking.v1.HTTPIngressPath
 */
export declare type HTTPIngressPathValid = Message<"k8s.io.api.networking.v1.HTTPIngressPath"> & {
  /**
   * Path is matched against the path of an incoming request. Currently it can
   * contain characters disallowed from the conventional "path" part of a URL
   * as defined by RFC 3986. Paths must begin with a '/' and must be present
 ...
 * @generated from message k8s.io.api.networking.v1.HTTPIngressRuleValue
 */
export declare type HTTPIngressRuleValueValid = Message<"k8s.io.api.networking.v1.HTTPIngressRuleValue"> & {
  /**
   * A collection of paths that map requests to backends.
   * +listType=atomic
   *
 ...
 * @generated from message k8s.io.api.networking.v1.IPBlock
 */
export declare type IPBlockValid = Message<"k8s.io.api.networking.v1.IPBlock"> & {
  /**
   * CIDR is a string representing the IP Block
   * Valid examples are "192.168.1.1/24" or "2001:db9::/64"
   *
 ...
 * @generated from message k8s.io.api.networking.v1.Ingress
 */
export declare type IngressValid = Message<"k8s.io.api.networking.v1.Ingress"> & {
  /**
   * Standard object's metadata.
   * More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
   * +optional
 ...
 * @generated from message k8s.io.api.networking.v1.IngressBackend
 */
export declare type IngressBackendValid = Message<"k8s.io.api.networking.v1.IngressBackend"> & {
  /**
   * Service references a Service as a Backend.
   * This is a mutually exclusive setting with "Resource".
   * +optional
   ...
   * @generated from field: optional k8s.io.api.networking.v1.IngressServiceBackend service = 4;
   */
  service?: IngressServiceBackendValid;
   ...
   * @generated from field: optional k8s.io.api.core.v1.TypedLocalObjectReference resource = 3;
   */
  resource?: TypedLocalObjectReferenceValid;
};
 ...
 * @generated from message k8s.io.api.networking.v1.IngressClass
 */
export declare type IngressClassValid = Message<"k8s.io.api.networking.v1.IngressClass"> & {
  /**
   * Standard object's metadata.
   * More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
   * +optional
 ...
 * @generated from message k8s.io.api.networking.v1.IngressClassList
 */
export declare type IngressClassListValid = Message<"k8s.io.api.networking.v1.IngressClassList"> & {
  /**
   * Standard list metadata.
   * +optional
   *
 ...
 * @generated from message k8s.io.api.networking.v1.IngressClassParametersReference
 */
export declare type IngressClassParametersReferenceValid = Message<"k8s.io.api.networking.v1.IngressClassParametersReference"> & {
  /**
   * APIGroup is the group for the resource being referenced. If APIGroup is
   * not specified, the specified Kind must be in the core API group. For any
   * other third-party types, APIGroup is required.
 ...
 * @generated from message k8s.io.api.networking.v1.IngressClassSpec
 */
export declare type IngressClassSpecValid = Message<"k8s.io.api.networking.v1.IngressClassSpec"> & {
  /**
   * Controller refers to the name of the controller that should handle this
   * class. This allows for different "flavors" that are controlled by the
   * same controller. For example, you may have different Parameters for the
   ...
   * @generated from field: optional k8s.io.api.networking.v1.IngressClassParametersReference parameters = 2;
   */
  parameters?: IngressClassParametersReferenceValid;
};
 ...
 * @generated from message k8s.io.api.networking.v1.IngressList
 */
export declare type IngressListValid = Message<"k8s.io.api.networking.v1.IngressList"> & {
  /**
   * Standard object's metadata.
   * More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
   * +optional
 ...
 * @generated from message k8s.io.api.networking.v1.IngressRule
 */
export declare type IngressRuleValid = Message<"k8s.io.api.networking.v1.IngressRule"> & {
  /**
   * Host is the fully qualified domain name of a network host, as defined by RFC 3986.
   * Note the following deviations from the "host" part of the
   * URI as defined in RFC 3986:
   ...
   * @generated from field: optional k8s.io.api.networking.v1.IngressRuleValue ingressRuleValue = 2;
   */
  ingressRuleValue?: IngressRuleValueValid;
};
 ...
 * @generated from message k8s.io.api.networking.v1.IngressRuleValue
 */
export declare type IngressRuleValueValid = Message<"k8s.io.api.networking.v1.IngressRuleValue"> & {
  /**
   * +optional
   *
   * @generated from field: optional k8s.io.api.networking.v1.HTTPIngressRuleValue http = 1;
   */
  http?: HTTPIngressRuleValueValid;
};
 ...
 * @generated from message k8s.io.api.networking.v1.IngressServiceBackend
 */
export declare type IngressServiceBackendValid = Message<"k8s.io.api.networking.v1.IngressServiceBackend"> & {
  /**
   * Name is the referenced service. The service must exist in
   * the same namespace as the Ingress object.
   *
 ...
 * @generated from message k8s.io.api.networking.v1.IngressSpec
 */
export declare type IngressSpecValid = Message<"k8s.io.api.networking.v1.IngressSpec"> & {
  /**
   * IngressClassName is the name of the IngressClass cluster resource. The
   * associated IngressClass defines which controller will implement the
   * resource. This replaces the deprecated `kubernetes.io/ingress.class`
   ...
   * @generated from field: optional k8s.io.api.networking.v1.IngressBackend defaultBackend = 1;
   */
  defaultBackend?: IngressBackendValid;
 ...
 * @generated from message k8s.io.api.networking.v1.IngressStatus
 */
export declare type IngressStatusValid = Message<"k8s.io.api.networking.v1.IngressStatus"> & {
  /**
   * LoadBalancer contains the current status of the load-balancer.
   * +optional
   *
 ...
 * @generated from message k8s.io.api.networking.v1.IngressTLS
 */
export declare type IngressTLSValid = Message<"k8s.io.api.networking.v1.IngressTLS"> & {
  /**
   * Hosts are a list of hosts included in the TLS certificate. The values in
   * this list must match the name/s used in the tlsSecret. Defaults to the
   * wildcard host setting for the loadbalancer controller fulfilling this
 ...
 * @generated from message k8s.io.api.networking.v1.NetworkPolicy
 */
export declare type NetworkPolicyValid = Message<"k8s.io.api.networking.v1.NetworkPolicy"> & {
  /**
   * Standard object's metadata.
   * More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
   * +optional
 ...
 * @generated from message k8s.io.api.networking.v1.NetworkPolicyEgressRule
 */
export declare type NetworkPolicyEgressRuleValid = Message<"k8s.io.api.networking.v1.NetworkPolicyEgressRule"> & {
  /**
   * List of destination ports for outgoing traffic.
   * Each item in this list is combined using a logical OR. If this field is
   * empty or missing, this rule matches all ports (traffic not restricted by port).
 ...
 * @generated from message k8s.io.api.networking.v1.NetworkPolicyIngressRule
 */
export declare type NetworkPolicyIngressRuleValid = Message<"k8s.io.api.networking.v1.NetworkPolicyIngressRule"> & {
  /**
   * List of ports which should be made accessible on the pods selected for this
   * rule. Each item in this list is combined using a logical OR. If this field is
   * empty or missing, this rule matches all ports (traffic not restricted by port).
 ...
 * @generated from message k8s.io.api.networking.v1.NetworkPolicyList
 */
export declare type NetworkPolicyListValid = Message<"k8s.io.api.networking.v1.NetworkPolicyList"> & {
  /**
   * Standard list metadata.
   * More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
   * +optional
 ...
 * @generated from message k8s.io.api.networking.v1.NetworkPolicyPeer
 */
export declare type NetworkPolicyPeerValid = Message<"k8s.io.api.networking.v1.NetworkPolicyPeer"> & {
  /**
   * This is a label selector which selects Pods. This field follows standard label
   * selector semantics; if present but empty, it selects all pods.
   *
   ...
   * @generated from field: optional k8s.io.apimachinery.pkg.apis.meta.v1.LabelSelector podSelector = 1;
   */
  podSelector?: LabelSelectorValid;
 ...
 * @generated from message k8s.io.api.networking.v1.NetworkPolicyPort
 */
export declare type NetworkPolicyPortValid = Message<"k8s.io.api.networking.v1.NetworkPolicyPort"> & {
  /**
   * The protocol (TCP, UDP, or SCTP) which traffic must match. If not specified, this
   * field defaults to TCP.
   * +optional
 ...
 * @generated from message k8s.io.api.networking.v1.NetworkPolicySpec
 */
export declare type NetworkPolicySpecValid = Message<"k8s.io.api.networking.v1.NetworkPolicySpec"> & {
  /**
   * Selects the pods to which this NetworkPolicy object applies. The array of
   * ingress rules is applied to any pods selected by this field. Multiple network
   * policies can select the same set of pods. In this case, the ingress rules for
 ...
 * @generated from message k8s.io.api.networking.v1.ServiceBackendPort
 */
export declare type ServiceBackendPortValid = Message<"k8s.io.api.networking.v1.ServiceBackendPort"> & {
  /**
   * Name is the name of the port on the Service.
   * This is a mutually exclusive setting with "Number".
   * +optional
