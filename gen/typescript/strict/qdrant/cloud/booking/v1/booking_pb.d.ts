 ...
 * @generated from message qdrant.cloud.booking.v1.ListPackagesRequest
 */
export declare type ListPackagesRequestValid = Message<"qdrant.cloud.booking.v1.ListPackagesRequest"> & {
  /**
   * The identifier of the account (in GUID format).
   * This is a required field.
   *
 ...
 * @generated from message qdrant.cloud.booking.v1.ListPackagesResponse
 */
export declare type ListPackagesResponseValid = Message<"qdrant.cloud.booking.v1.ListPackagesResponse"> & {
  /**
   * The actual packages in this list
   *
   * @generated from field: repeated qdrant.cloud.booking.v1.Package items = 1;
 ...
 * @generated from message qdrant.cloud.booking.v1.ListGlobalPackagesRequest
 */
export declare type ListGlobalPackagesRequestValid = Message<"qdrant.cloud.booking.v1.ListGlobalPackagesRequest"> & {
  /**
   * Mandatory filter specifying the cloud provider where the cluster will be hosted.
   * Must match one of the provider IDs returned by the `qdrant.cloud.platform.v1.PlatformService.ListGlobalCloudProviders` method.
   *
 ...
 * @generated from message qdrant.cloud.booking.v1.ListGlobalPackagesResponse
 */
export declare type ListGlobalPackagesResponseValid = Message<"qdrant.cloud.booking.v1.ListGlobalPackagesResponse"> & {
  /**
   * The actual packages in this list
   *
   * @generated from field: repeated qdrant.cloud.booking.v1.Package items = 1;
 ...
 * @generated from message qdrant.cloud.booking.v1.GetPackageRequest
 */
export declare type GetPackageRequestValid = Message<"qdrant.cloud.booking.v1.GetPackageRequest"> & {
  /**
   * The identifier of the account (in GUID format).
   * This is a required field.
   *
 ...
 * @generated from message qdrant.cloud.booking.v1.Package
 */
export declare type PackageValid = Message<"qdrant.cloud.booking.v1.Package"> & {
  /**
   * The unique identifier of the package.
   * A unique string ID assigned to each package.
   *
   ...
   * @generated from field: qdrant.cloud.booking.v1.ResourceConfiguration resource_configuration = 4;
   */
  resourceConfiguration?: ResourceConfigurationValid;
   ...
   * @generated from field: optional qdrant.cloud.booking.v1.AvailableAdditionalResources available_additional_resources = 8;
   */
  availableAdditionalResources?: AvailableAdditionalResourcesValid;
};
 ...
 * @generated from message qdrant.cloud.booking.v1.AvailableAdditionalResources
 */
export declare type AvailableAdditionalResourcesValid = Message<"qdrant.cloud.booking.v1.AvailableAdditionalResources"> & {
  /**
   * The unit price per hour in millicents, in integer format.
   * Represents the cost per hour for a single unit(GiB) of the resource.
   * You will be billed hourly for the resources you use. Partial hours are rounded up and billed as full hours.
 ...
 * @generated from message qdrant.cloud.booking.v1.ResourceConfiguration
 */
export declare type ResourceConfigurationValid = Message<"qdrant.cloud.booking.v1.ResourceConfiguration"> & {
  /**
   * The amount of RAM (e.g., "1GiB")
   *
   * @generated from field: string ram = 1;
 ...
 * @generated from message qdrant.cloud.booking.v1.GetQuoteRequest
 */
export declare type GetQuoteRequestValid = Message<"qdrant.cloud.booking.v1.GetQuoteRequest"> & {
  /**
   * The identifier of the account (in GUID format).
   * This is a required field.
   *
 ...
 * @generated from message qdrant.cloud.booking.v1.GetQuoteResponse
 */
export declare type GetQuoteResponseValid = Message<"qdrant.cloud.booking.v1.GetQuoteResponse"> & {
  /**
   * The currency of the prices.
   * Specifies the currency in which the prices are denominated.
   * Must be a 3-letter ISO 4217 currency code (e.g., "USD").
 ...
 * @generated from message qdrant.cloud.booking.v1.ListInferenceModelsRequest
 */
export declare type ListInferenceModelsRequestValid = Message<"qdrant.cloud.booking.v1.ListInferenceModelsRequest"> & {
  /**
   * The identifier of the account (in GUID format).
   * This is a required field.
   *
 ...
 * @generated from message qdrant.cloud.booking.v1.ListInferenceModelsResponse
 */
export declare type ListInferenceModelsResponseValid = Message<"qdrant.cloud.booking.v1.ListInferenceModelsResponse"> & {
  /**
   * The actual inference models in this list
   *
   * @generated from field: repeated qdrant.cloud.booking.v1.InferenceModel items = 1;
   */
  items: InferenceModelValid[];
};
 ...
 * @generated from message qdrant.cloud.booking.v1.InferenceModel
 */
export declare type InferenceModelValid = Message<"qdrant.cloud.booking.v1.InferenceModel"> & {
  /**
   * The unique identifier of the inference model.
   *
   * @generated from field: string id = 1;
