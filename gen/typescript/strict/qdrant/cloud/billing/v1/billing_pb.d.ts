 ...
 * @generated from message qdrant.cloud.billing.v1.ListInvoicesRequest
 */
export declare type ListInvoicesRequestValid = Message<"qdrant.cloud.billing.v1.ListInvoicesRequest"> & {
  /**
   * The identifier of the account (in GUID format).
   * This is a required field.
   *
 ...
 * @generated from message qdrant.cloud.billing.v1.ListDiscountsRequest
 */
export declare type ListDiscountsRequestValid = Message<"qdrant.cloud.billing.v1.ListDiscountsRequest"> & {
  /**
   * The identifier of the account (in GUID format).
   * This is a required field.
   *
 ...
 * @generated from message qdrant.cloud.billing.v1.DiscountPercentage
 */
export declare type DiscountPercentageValid = Message<"qdrant.cloud.billing.v1.DiscountPercentage"> & {
  /**
   * The percentage value (e.g., 12.5 for 12.5%). Must be between 0 and 100.
   *
   * @generated from field: double value = 1;
 ...
 * @generated from message qdrant.cloud.billing.v1.DiscountFixed
 */
export declare type DiscountFixedValid = Message<"qdrant.cloud.billing.v1.DiscountFixed"> & {
  /**
   * The discount amount as a decimal. Must be positive.
   *
   * @generated from field: double value = 1;
