 ...
 * @generated from message qdrant.cloud.cluster.auth.v1.CreateEphemeralDashboardTokenRequest
 */
export declare type CreateEphemeralDashboardTokenRequestValid = Message<"qdrant.cloud.cluster.auth.v1.CreateEphemeralDashboardTokenRequest"> & {
  /**
   * The identifier of the account (in GUID format).
   * This is a required field.
   *
 ...
 * @generated from message qdrant.cloud.cluster.auth.v1.EphemeralDashboardToken
 */
export declare type EphemeralDashboardTokenValid = Message<"qdrant.cloud.cluster.auth.v1.EphemeralDashboardToken"> & {
  /**
   * token is used as cookie value
   * Example: local:v1:string
   *
