...
export declare type GetClusterUsageMetricsResponse = Message<"qdrant.cloud.monitoring.v1.GetClusterUsageMetricsResponse"> & {
   ...
   *
   * @generated from field: repeated qdrant.cloud.monitoring.v1.Metric vram = 11;
   */
  vram: Metric[];
};
...
export declare type ClusterNodeMetrics = Message<"qdrant.cloud.monitoring.v1.ClusterNodeMetrics"> & {
  ...
  /**
   * Overview of GPU memory usage.
   *
   * @generated from field: optional qdrant.cloud.monitoring.v1.ClusterMetricOverview vram = 9;
   */
...
export declare type ClusterNodeMetricsValid = Message<"qdrant.cloud.monitoring.v1.ClusterNodeMetrics"> & {
   ...
   * @generated from field: optional qdrant.cloud.monitoring.v1.ClusterMetricOverview vram = 9;
   */
  vram?: ClusterMetricOverviewValid;
};
...
export declare type ClusterNodeUsageMetrics = Message<"qdrant.cloud.monitoring.v1.ClusterNodeUsageMetrics"> & {
  ...
  /**
   * Timeseries of gpu memory usage for the node.
   *
   * @generated from field: repeated qdrant.cloud.monitoring.v1.Metric vram = 9;
   */
  vram: Metric[];
};
