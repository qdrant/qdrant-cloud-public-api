...
export declare type UpgradeCollectionRequestValid = UpgradeCollectionRequest;
...
export declare type UpgradeCollectionResponseValid = UpgradeCollectionResponse;
...
export declare type CollectionValid = Collection;
...
export declare type CollectionState = Message<"qdrant.cloud.serverless.collection.v1.CollectionState"> & {
   ...
   */
  endpoint?: CollectionEndpoint | undefined;
};

export declare type CollectionStateValid = CollectionState;
...
export declare type CollectionEndpointValid = CollectionEndpoint;
