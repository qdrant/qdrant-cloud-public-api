 ...
 * @generated from message qdrant.cloud.cluster.v1.ListClustersResponse
 */
export declare type ListClustersResponseValid = Message<"qdrant.cloud.cluster.v1.ListClustersResponse"> & {
  /**
   * The actual clusters in this list
   *
   * @generated from field: repeated qdrant.cloud.cluster.v1.Cluster items = 1;
 ...
 *
 * @generated from message qdrant.cloud.cluster.v1.GetClusterDownscaleRiskRequest
 */
export declare type GetClusterDownscaleRiskRequest = Message<"qdrant.cloud.cluster.v1.GetClusterDownscaleRiskRequest"> & {
  /**
...
export declare type GetClusterDownscaleRiskRequestValid = GetClusterDownscaleRiskRequest;
 ...
 */
export declare const GetClusterDownscaleRiskRequestSchema: GenMessage<GetClusterDownscaleRiskRequest, {validType: GetClusterDownscaleRiskRequestValid}>;

/**
 * GetClusterDownscaleRiskResponse is the response from the GetClusterDownscaleRisk function.
 *
 * @generated from message qdrant.cloud.cluster.v1.GetClusterDownscaleRiskResponse
 */
export declare type GetClusterDownscaleRiskResponse = Message<"qdrant.cloud.cluster.v1.GetClusterDownscaleRiskResponse"> & {
  /**
   ...
   *
   * @generated from field: repeated qdrant.cloud.cluster.v1.ClusterDownscaleRiskInfo downscale_risks = 1;
   */
  downscaleRisks: ClusterDownscaleRiskInfo[];
};

export declare type GetClusterDownscaleRiskResponseValid = GetClusterDownscaleRiskResponse;
 ...
 */
export declare const GetClusterDownscaleRiskResponseSchema: GenMessage<GetClusterDownscaleRiskResponse, {validType: GetClusterDownscaleRiskResponseValid}>;
...
export declare type GetQdrantReleaseResponse = Message<"qdrant.cloud.cluster.v1.GetQdrantReleaseResponse"> & {
   ...
   */
  release?: QdrantRelease | undefined;
};
...
export declare type ClusterValid = Message<"qdrant.cloud.cluster.v1.Cluster"> & {
   ...
   * @generated from field: qdrant.cloud.cluster.v1.ClusterState state = 100;
   */
  state?: ClusterStateValid | undefined;
};
...
export declare type ClusterConfiguration = Message<"qdrant.cloud.cluster.v1.ClusterConfiguration"> & {
   ...
   */
  reservedCpuPercentage?: number | undefined;
   ...
   */
  reservedMemoryPercentage?: number | undefined;
   ...
   */
  gpuType?: ClusterConfigurationGpuType | undefined;
   ...
   */
  restartPolicy?: ClusterConfigurationRestartPolicy | undefined;
   ...
   */
  rebalanceStrategy?: ClusterConfigurationRebalanceStrategy | undefined;
 ...
 * @generated from message qdrant.cloud.cluster.v1.ClusterConfiguration
 */
export declare type ClusterConfigurationValid = Message<"qdrant.cloud.cluster.v1.ClusterConfiguration"> & {
  /**
   * Timestamp when the cluster configuration was last updated.
   * This is a read-only field and will be available after a cluster is created.
   *
   ...
   * @generated from field: optional qdrant.cloud.cluster.v1.AdditionalResources additional_resources = 5;
   */
  additionalResources?: AdditionalResourcesValid | undefined;
   ...
   * @generated from field: optional qdrant.cloud.cluster.v1.DatabaseConfiguration database_configuration = 7;
   */
  databaseConfiguration?: DatabaseConfigurationValid | undefined;
   ...
   * @generated from field: repeated qdrant.cloud.common.v1.KeyValue service_annotations = 13;
   */
  serviceAnnotations: KeyValueValid[];
...
export declare type DatabaseConfiguration = Message<"qdrant.cloud.cluster.v1.DatabaseConfiguration"> & {
   ...
   */
  collection?: DatabaseConfigurationCollection | undefined;
   ...
   */
  storage?: DatabaseConfigurationStorage | undefined;
   ...
   */
  service?: DatabaseConfigurationService | undefined;
   ...
   */
  logLevel?: DatabaseConfigurationLogLevel | undefined;
   ...
   */
  tls?: DatabaseConfigurationTls | undefined;
   ...
   */
  inference?: DatabaseConfigurationInference | undefined;
   ...
   */
  auditLogging?: DatabaseConfigurationAuditLogging | undefined;
};
 ...
 * @generated from message qdrant.cloud.cluster.v1.DatabaseConfiguration
 */
export declare type DatabaseConfigurationValid = Message<"qdrant.cloud.cluster.v1.DatabaseConfiguration"> & {
  /**
   * The default Qdrant database collection configuration.
   * This setting is for both managed and hybrid cloud clusters, see sub-messages for more details.
   * This is an optional field.
   ...
   * @generated from field: optional qdrant.cloud.cluster.v1.DatabaseConfigurationCollection collection = 1;
   */
  collection?: DatabaseConfigurationCollectionValid | undefined;
   ...
   * @generated from field: optional qdrant.cloud.cluster.v1.DatabaseConfigurationStorage storage = 2;
   */
  storage?: DatabaseConfigurationStorageValid | undefined;
   ...
   * @generated from field: optional qdrant.cloud.cluster.v1.DatabaseConfigurationService service = 3;
   */
  service?: DatabaseConfigurationServiceValid | undefined;
   ...
   * @generated from field: optional qdrant.cloud.cluster.v1.DatabaseConfigurationTls tls = 5;
   */
  tls?: DatabaseConfigurationTlsValid | undefined;
   ...
   * @generated from field: optional qdrant.cloud.cluster.v1.DatabaseConfigurationInference inference = 6;
   */
  inference?: DatabaseConfigurationInferenceValid | undefined;
   ...
   * @generated from field: optional qdrant.cloud.cluster.v1.DatabaseConfigurationAuditLogging audit_logging = 7;
   */
  auditLogging?: DatabaseConfigurationAuditLoggingValid | undefined;
};
...
export declare type DatabaseConfigurationCollection = Message<"qdrant.cloud.cluster.v1.DatabaseConfigurationCollection"> & {
   ...
   */
  vectors?: DatabaseConfigurationCollectionVectors | undefined;
};
...
export declare type DatabaseConfigurationStorage = Message<"qdrant.cloud.cluster.v1.DatabaseConfigurationStorage"> & {
   ...
   */
  performance?: DatabaseConfigurationStoragePerformance | undefined;
};
...
export declare type DatabaseConfigurationStoragePerformance = Message<"qdrant.cloud.cluster.v1.DatabaseConfigurationStoragePerformance"> & {
   ...
   */
  optimizerCpuBudget?: number | undefined;
...
export declare type DatabaseConfigurationService = Message<"qdrant.cloud.cluster.v1.DatabaseConfigurationService"> & {
   ...
   */
  readOnlyApiKey?: SecretKeyRef | undefined;
...
export declare type DatabaseConfigurationAuditLogging = Message<"qdrant.cloud.cluster.v1.DatabaseConfigurationAuditLogging"> & {
   ...
   */
  rotation?: AuditLogRotation | undefined;
   ...
   */
  trustForwardedHeaders?: boolean | undefined;
};
...
export declare type Toleration = Message<"qdrant.cloud.cluster.v1.Toleration"> & {
   ...
   */
  operator?: TolerationOperator | undefined;
   ...
   */
  effect?: TolerationEffect | undefined;
   ...
   */
  tolerationSeconds?: bigint | undefined;
};
...
export declare type ClusterStorageConfiguration = Message<"qdrant.cloud.cluster.v1.ClusterStorageConfiguration"> & {
   ...
   */
  databaseStorageClass?: string | undefined;
   ...
   */
  snapshotStorageClass?: string | undefined;
   ...
   */
  volumeSnapshotClass?: string | undefined;
   ...
   */
  volumeAttributesClass?: string | undefined;
};
...
export declare type ClusterState = Message<"qdrant.cloud.cluster.v1.ClusterState"> & {
   ...
   */
  restartedAt?: Timestamp | undefined;
   ...
   */
  endpoint?: ClusterEndpoint | undefined;
   ...
   */
  resources?: ClusterNodeResourcesSummary | undefined;
   ...
   * @deprecated
   */
  scalabilityInfo?: ClusterScalabilityInfo | undefined;
   ...
   */
  capabilities?: ClusterCapabilities | undefined;
};
...
export declare type ClusterNodeNotReadyInfo = Message<"qdrant.cloud.cluster.v1.ClusterNodeNotReadyInfo"> & {
   ...
   *
   * @generated from field: optional qdrant.cloud.cluster.v1.ClusterNodeNotReadyReason reason = 6;
   */
  reason?: ClusterNodeNotReadyReason | undefined;
   ...
   *
   * @generated from field: optional string reason_message = 7;
   */
...
export declare type ClusterNodeResourcesSummary = Message<"qdrant.cloud.cluster.v1.ClusterNodeResourcesSummary"> & {
   ...
   */
  disk?: ClusterNodeResources | undefined;
   ...
   */
  ram?: ClusterNodeResources | undefined;
   ...
   */
  cpu?: ClusterNodeResources | undefined;
   ...
   */
  gpu?: ClusterNodeResources | undefined;

  /**
   * GPU RAM, empty if cluster has not GPU.
   *
   * @generated from field: optional qdrant.cloud.cluster.v1.ClusterNodeResources gpu_ram = 5;
   */
  gpuRam?: ClusterNodeResources | undefined;
};
...
export declare type ClusterNodeResourcesSummaryValid = Message<"qdrant.cloud.cluster.v1.ClusterNodeResourcesSummary"> & {
   ...
   * @generated from field: optional qdrant.cloud.cluster.v1.ClusterNodeResources gpu = 4;
   */
  gpu?: ClusterNodeResourcesValid | undefined;
   ...
   * @generated from field: optional qdrant.cloud.cluster.v1.ClusterNodeResources gpu_ram = 5;
   */
  gpuRam?: ClusterNodeResourcesValid | undefined;
};
 ...
 *
 * @generated from message qdrant.cloud.cluster.v1.ClusterDownscaleRiskInfo
 */
export declare type ClusterDownscaleRiskInfo = Message<"qdrant.cloud.cluster.v1.ClusterDownscaleRiskInfo"> & {
  /**
   * The resource the risk is assessed for.
   *
   * @generated from field: qdrant.cloud.cluster.v1.ClusterDownscaleRiskResource resource = 1;
   */
   ...
   *
   * @generated from field: qdrant.cloud.cluster.v1.ClusterDownscaleRiskStatus status = 2;
   */
...
export declare type ClusterDownscaleRiskInfoValid = ClusterDownscaleRiskInfo;
 ...
 */
export declare const ClusterDownscaleRiskInfoSchema: GenMessage<ClusterDownscaleRiskInfo, {validType: ClusterDownscaleRiskInfoValid}>;
...
export declare type ClusterCapabilities = Message<"qdrant.cloud.cluster.v1.ClusterCapabilities"> & {
   ...
   */
  diskExpansion?: ClusterDiskExpansionSupportInfo | undefined;
   ...
   */
  backup?: ClusterBackupSupportInfo | undefined;
 ...
 */
export enum ClusterNodeNotReadyReason {
  /**
   * The reason is unspecified.
   *
   * @generated from enum value: CLUSTER_NODE_NOT_READY_REASON_UNSPECIFIED = 0;
   */
  UNSPECIFIED = 0,
   ...
   *
   * @generated from enum value: CLUSTER_NODE_NOT_READY_REASON_INSUFFICIENT_RESOURCES = 1;
   */
   ...
   * Reported under CLUSTER_NODE_NOT_READY_CONDITION_POD_SCHEDULING_ERROR.
   *
   * @generated from enum value: CLUSTER_NODE_NOT_READY_REASON_NODE_CONSTRAINTS_UNSATISFIED = 2;
   */
  NODE_CONSTRAINTS_UNSATISFIED = 2,
   ...
   *
   * @generated from enum value: CLUSTER_NODE_NOT_READY_REASON_VOLUME_UNAVAILABLE = 3;
   */
   ...
   *
   * @generated from enum value: CLUSTER_NODE_NOT_READY_REASON_IMAGE_UNAVAILABLE = 4;
   */
  IMAGE_UNAVAILABLE = 4,
   ...
   * Reported under CLUSTER_NODE_NOT_READY_CONDITION_CONTAINER_START_BLOCKED.
   *
   * @generated from enum value: CLUSTER_NODE_NOT_READY_REASON_CONFIGURATION_MISSING = 5;
   */
  CONFIGURATION_MISSING = 5,
   ...
   *
   * @generated from enum value: CLUSTER_NODE_NOT_READY_REASON_OUT_OF_MEMORY = 6;
   */
  OUT_OF_MEMORY = 6,
   ...
   * Reported only under CLUSTER_NODE_NOT_READY_CONDITION_CONTAINER_RESTARTING.
   *
   * @generated from enum value: CLUSTER_NODE_NOT_READY_REASON_PROCESS_EXITED = 7;
   */
  PROCESS_EXITED = 7,
}
...
export enum ClusterNodeActionKind {
   ...
   *
   * @generated from enum value: CLUSTER_NODE_ACTION_KIND_VIEW_LOGS = 3;
   */
  VIEW_LOGS = 3,
}
 ...
 */
export enum ClusterDownscaleRiskResource {
  /**
   * Downscale risk resource is unspecified.
   *
   * @generated from enum value: CLUSTER_DOWNSCALE_RISK_RESOURCE_UNSPECIFIED = 0;
   */
  UNSPECIFIED = 0,
   ...
   *
   * @generated from enum value: CLUSTER_DOWNSCALE_RISK_RESOURCE_MEMORY = 1;
   */
  MEMORY = 1,
}
 ...
 */
export declare const ClusterDownscaleRiskResourceSchema: GenEnum<ClusterDownscaleRiskResource>;
 ...
 */
export enum ClusterDownscaleRiskStatus {
  /**
   * Downscale risk is unspecified.
   *
   * @generated from enum value: CLUSTER_DOWNSCALE_RISK_STATUS_UNSPECIFIED = 0;
   */
  UNSPECIFIED = 0,
   ...
   *
   * @generated from enum value: CLUSTER_DOWNSCALE_RISK_STATUS_NO_RISK = 1;
   */
  NO_RISK = 1,
   ...
   * properties provide.
   *
   * @generated from enum value: CLUSTER_DOWNSCALE_RISK_STATUS_USAGE_EXCEEDS_TARGET = 2;
   */
  USAGE_EXCEEDS_TARGET = 2,

  /**
   * The cluster's usage of the resource could not be determined, so the risk is unknown.
   *
   * @generated from enum value: CLUSTER_DOWNSCALE_RISK_STATUS_USAGE_UNKNOWN = 3;
   */
  USAGE_UNKNOWN = 3,
}
 ...
 */
export declare const ClusterDownscaleRiskStatusSchema: GenEnum<ClusterDownscaleRiskStatus>;
...
export declare const ClusterService: GenService<{
  ...
  getClusterDownscaleRisk: {
    methodKind: "unary";
    input: typeof GetClusterDownscaleRiskRequestSchema;
    output: typeof GetClusterDownscaleRiskResponseSchema;
  },
  /**
