...
import type { KeyValue, SecretKeyRef } from "../../common/v1/common_pb.js";
 ...
 */
export declare const RestartClusterRequestSchema: GenMessage<RestartClusterRequest>;
 ...
 */
export declare const RestartClusterResponseSchema: GenMessage<RestartClusterResponse>;
 ...
 */
export declare const SuspendClusterRequestSchema: GenMessage<SuspendClusterRequest>;
 ...
 */
export declare const SuspendClusterResponseSchema: GenMessage<SuspendClusterResponse>;
 ...
 */
export declare const SuggestClusterNameRequestSchema: GenMessage<SuggestClusterNameRequest>;
 ...
 */
export declare const SuggestClusterNameResponseSchema: GenMessage<SuggestClusterNameResponse>;
 ...
 */
export declare const ListQdrantReleasesRequestSchema: GenMessage<ListQdrantReleasesRequest>;
 ...
 */
export declare const ListQdrantReleasesResponseSchema: GenMessage<ListQdrantReleasesResponse>;
 ...
 */
export declare const DatabaseConfigurationSchema: GenMessage<DatabaseConfiguration>;
 ...
 */
export declare const DatabaseConfigurationCollectionSchema: GenMessage<DatabaseConfigurationCollection>;
 ...
 */
export declare const DatabaseConfigurationCollectionVectorsSchema: GenMessage<DatabaseConfigurationCollectionVectors>;
 ...
 */
export declare const DatabaseConfigurationStorageSchema: GenMessage<DatabaseConfigurationStorage>;
 ...
 */
export declare const DatabaseConfigurationStoragePerformanceSchema: GenMessage<DatabaseConfigurationStoragePerformance>;
 ...
 */
export declare const DatabaseConfigurationServiceSchema: GenMessage<DatabaseConfigurationService>;
 ...
 */
export declare const DatabaseConfigurationTlsSchema: GenMessage<DatabaseConfigurationTls>;
 ...
 */
export declare const DatabaseConfigurationInferenceSchema: GenMessage<DatabaseConfigurationInference>;
 ...
 */
export declare const AdditionalResourcesSchema: GenMessage<AdditionalResources>;
 ...
 */
export declare const ClusterEndpointSchema: GenMessage<ClusterEndpoint>;
 ...
 */
export declare const ClusterNodeResourcesSummarySchema: GenMessage<ClusterNodeResourcesSummary>;
